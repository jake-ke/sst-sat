...
solver = sst.Component("solver", "satsolver-confl1.SATSolver-confl1")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-confl1.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-confl1.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
