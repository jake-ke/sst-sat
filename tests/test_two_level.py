...
solver = sst.Component("solver", "satsolver-mc-gba.SATSolver-mc-gba")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-gba.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-gba.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
