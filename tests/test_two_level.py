...
solver = sst.Component("solver", "satsolver-mc.SATSolver-mc")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
