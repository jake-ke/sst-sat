...
solver = sst.Component("solver", "satsolver-opt5-prewatcher.SATSolver-opt5-prewatcher")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-opt5-prewatcher.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-opt5-prewatcher.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
