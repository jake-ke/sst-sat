...
solver = sst.Component("solver", "satsolver-opt1-lits.SATSolver-opt1-lits")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-opt1-lits.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-opt1-lits.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
