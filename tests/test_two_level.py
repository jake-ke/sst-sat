...
solver = sst.Component("solver", "satsolver-mc-lex.SATSolver-mc-lex")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-lex.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-lex.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
