...
solver = sst.Component("solver", "satsolver-opt5-min.SATSolver-opt5-min")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-opt5-min.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-opt5-min.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
