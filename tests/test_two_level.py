...
solver = sst.Component("solver", "satsolver-opt2-wats.SATSolver-opt2-wats")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-opt2-wats.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-opt2-wats.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
