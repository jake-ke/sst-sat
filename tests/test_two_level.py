...
solver = sst.Component("solver", "satsolver-mc-bml.SATSolver-mc-bml")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-bml.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-bml.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
