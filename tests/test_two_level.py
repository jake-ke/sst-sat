...
solver = sst.Component("solver", "satsolver-mc-gmc0.SATSolver-mc-gmc0")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-gmc0.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-gmc0.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
