...
solver = sst.Component("solver", "satsolver-mc-gmclbd.SATSolver-mc-gmclbd")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-gmclbd.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-gmclbd.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
