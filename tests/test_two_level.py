...
solver = sst.Component("solver", "satsolver-opt3-heap.SATSolver-opt3-heap")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-opt3-heap.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-opt3-heap.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
