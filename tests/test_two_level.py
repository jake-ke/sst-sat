...
solver = sst.Component("solver", "satsolver-mc-bm.SATSolver-mc-bm")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-bm.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-bm.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
