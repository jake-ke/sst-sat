...
solver = sst.Component("solver", "satsolver-opt4-new-learn.SATSolver-opt4-new-learn")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-opt4-new-learn.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-opt4-new-learn.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
