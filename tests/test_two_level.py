...
solver = sst.Component("solver", "satsolver-mc-gmc1d.SATSolver-mc-gmc1d")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-gmc1d.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-gmc1d.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
