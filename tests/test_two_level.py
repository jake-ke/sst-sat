...
solver = sst.Component("solver", "satsolver-mc-instr.SATSolver-mc-instr")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-instr.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-instr.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
