...
solver = sst.Component("solver", "satsolver-mc-adaptive.SATSolver-mc-adaptive")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-adaptive.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-adaptive.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
