...
solver = sst.Component("solver", "satsolver-mc-gmc1dl.SATSolver-mc-gmc1dl")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-gmc1dl.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-gmc1dl.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
