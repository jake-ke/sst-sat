...
solver = sst.Component("solver", "satsolver-mc-lenmin.SATSolver-mc-lenmin")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-lenmin.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-lenmin.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
