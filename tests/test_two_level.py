...
solver = sst.Component("solver", "satsolver-mc-lbd.SATSolver-mc-lbd")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-lbd.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-lbd.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
