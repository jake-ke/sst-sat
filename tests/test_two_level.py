...
solver = sst.Component("solver", "satsolver-opt5-learn.SATSolver-opt5-learn")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-opt5-learn.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-opt5-learn.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
