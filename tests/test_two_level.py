...
solver = sst.Component("solver", "satsolver-opt6-min.SATSolver-opt6-min")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-opt6-min.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-opt6-min.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
