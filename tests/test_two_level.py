...
solver = sst.Component("solver", "satsolver-mc-subsume.SATSolver-mc-subsume")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-subsume.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-subsume.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
