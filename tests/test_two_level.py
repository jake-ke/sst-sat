...
solver = sst.Component("solver", "satsolver-mc-gmcdl.SATSolver-mc-gmcdl")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-gmcdl.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-gmcdl.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
