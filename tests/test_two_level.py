...
solver = sst.Component("solver", "satsolver-opt4-wl.SATSolver-opt4-wl")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-opt4-wl.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-opt4-wl.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
