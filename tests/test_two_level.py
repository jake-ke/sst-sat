...
solver = sst.Component("solver", "satsolver-confl4.SATSolver-confl4")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-confl4.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-confl4.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
