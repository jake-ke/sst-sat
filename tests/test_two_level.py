...
solver = sst.Component("solver", "satsolver-opt3-learn.SATSolver-opt3-learn")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-opt3-learn.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-opt3-learn.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
