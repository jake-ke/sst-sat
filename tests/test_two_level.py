...
solver = sst.Component("solver", "satsolver-confl12.SATSolver-confl12")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-confl12.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-confl12.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
