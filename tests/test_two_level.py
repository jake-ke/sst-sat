...
solver = sst.Component("solver", "satsolver-mc-bumpall.SATSolver-mc-bumpall")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-bumpall.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-bumpall.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
