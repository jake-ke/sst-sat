...
solver = sst.Component("solver", "satsolver-mc-gbm.SATSolver-mc-gbm")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-mc-gbm.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-mc-gbm.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
