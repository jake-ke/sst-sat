...
solver = sst.Component("solver", "satsolver-opt3-heap-min.SATSolver-opt3-heap-min")
...
if args.classic_heap:
    ...
    heap = solver.setSubComponent("order_heap", "satsolver-opt3-heap-min.Heap")
else:
    print("Using pipelined heap implementation")
    heap = solver.setSubComponent("order_heap", "satsolver-opt3-heap-min.PipelinedHeap")
heap.addParams({
    "verbose" : str(args.verbose),
})
print()
